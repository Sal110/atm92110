...
async function main() {
    ...
    if (pinAnswer.pin === myPin) {
        ...
        if (operationAns.operation === "Withdraw") {
            ...
            processWithdrawal(amountAns.amount); // Ensure 'amount' is treated as a number
        }
            ...
            processDeposit(depositAns.amount); // Ensure 'amount' is treated as a number
        }
            ...
            processWithdrawal(fastCashAns.amount); // Ensure 'amount' is treated as a number
        }
